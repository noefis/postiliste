...
import 'package:postiliste/home/home_page.dart';
...
import 'package:postiliste/thankyou/thank_you.dart';
import 'package:postiliste/thankyou/thank_you_confetti.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:flutter_gen/gen_l10n/app_localizations.dart';
import '../single_item/my_barcode_scanner.dart';
...
class _SingleItemThankYouView extends State<SingleItemThankYouViewRoute> {
  List<String> _list = [];
  ...
  void _setPrefs() async {
    ...
    prefs.setStringList("active", [widget.prefKey]);
